...
class App extends Component {
  state = {
    ...
    visitedCountriesList: [initialCountriesList[3], initialCountriesList[8]],
  }

  addCountry = id => {
    const {countriesList} = this.state
    const filteredData = countriesList.filter(eachItem => eachItem.id === id)
  ...
  onRemoveVisitedCountry = id => {
    ...
    const filteredData = visitedCountriesList.filter(
    ...
    this.setState({visitedCountriesList: filteredData})
  }
